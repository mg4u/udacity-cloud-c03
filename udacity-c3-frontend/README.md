...
1. [The Simple Frontend](https://github.com/grutt/udacity-c3-frontend) `This Repo`
A basic Ionic client web application which consumes the RestAPI Backend. 
2. [The RestAPI Backend](https://github.com/grutt/udacity-c3-restapi)
Which is a Node-Express server which can be deployed to a cloud service.
3. [The Image Filtering Microservice](https://github.com/grutt/udacity-c3-image-filter)
...
> _tip_: this frontend is designed to work with [The RestAPI Backend](https://github.com/grutt/udacity-c3-restapi). It is recommended you stand up the backend first, test using Postman, and then the frontend should integrate.
